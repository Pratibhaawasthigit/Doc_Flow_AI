        ...
        <section style={{ padding: "96px 32px" }}>
            <div style={{ maxWidth: 1280, margin: "0 auto" }}>
                <div style={{ textAlign: "center", marginBottom: 80 }}>
                    <h2 className="section-title-underline" style={{ fontSize: "clamp(1.8rem,3.5vw,40px)", fontWeight: 700, marginBottom: 16 }}>Unmatched Capabilities</h2>
                    <p style={{ color: "#434655", fontSize: 16 }}>Everything you need to master any subject and automate your workflow.</p>
                </div>
                <div className="feats-grid" style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: 32 }}>
                    {feats.map(f => (
                        <div key={f.t} className="feat-card" style={{ display: "flex", gap: 24, alignItems: "flex-start" }}>
                            <div className="feat-icon" style={{ flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", width: 56, height: 56 }}>
                                <span className="material-symbols-outlined" style={{ fontSize: 28, display: "block", textAlign: "center" }}>{f.ic}</span>
                            </div>
                            <div>
                                <h3 style={{ fontSize: 20, fontWeight: 700, marginBottom: 8 }}>{f.t}</h3>
                                <p style={{ color: "#434655", lineHeight: 1.65, fontSize: 15 }}>{f.d}</p>
                            </div>
                        </div>
                    ))}
                </div>
